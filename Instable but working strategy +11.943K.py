...
class Trader:
    ...
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        # trading of rainforest (9998 - 10002 arbitrage)
        ...
        # Trading of KELP (depending on the position)
        ...
        # No trading on SQUID INK (no working strategy in my opinion and after several try)
